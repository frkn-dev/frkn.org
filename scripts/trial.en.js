...
const TRIAL_I18N = {
  ...
  promoInvalid: "Hmm, this promo code doesn't work",
  refLabel: "Friend's referral code",
  refPlaceholder: "Enter friend's code",
  refApply: "Apply",
  refApplied:
    "Referral code applied. Your friend gets 30 days after your payment.",
  refInvalid: "Referral code not found",
  payPlanta: "Pay via SBP",
  payPlatega: "Pay with MIR card/Crypto",
  ...
  txidNote:
    "‼️ If the payment system doesn't bring you back — paste your payment ID into https://frkn.org/transaction?txid=<your payment ID>",
  keyNote: "Your key appears on the page right after payment — no email needed.",
  errorTitle: "Error",
  errorOk: "Got it",
  createFail: "Failed to create payment",
  noUrl: "API returned no payment link",
  noTxid: "API returned no transaction ID",
  plantaTimeout: "SBP didn't respond in time. Check status by transaction ID: ",
