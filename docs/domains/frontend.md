...
One shared stylesheet for ~40 "normal" pages. Connected as `/styles.css?v=8`.
...
Manual cache-busting query strings: `styles.css?v=8`, `i18n.js?v=2`, `containers.js?v=3`, `utils.js?v=1`. Bump when changing a shared asset.