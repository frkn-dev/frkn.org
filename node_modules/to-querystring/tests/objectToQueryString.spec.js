...
describe('object-to-querystring tests', () => {
  ...
  it('Convert simple object with array to query string with options', () => {
    ...
    expect(queryString).to.equal('test[]=testValue&test[]=testValue2');
  });
  ...
  it('Convert complex 1 layer deep object in an array to query string with prefix options', () => {
    const queryString = toQueryString({
      'test': {'deep': {'deep3': 'testValueDeep', 'test2': ['a', 'b', 'c']}, 'deep2': 'testd'},
      'test2': [{'deep': 'testDeepInArray', 'deep2': 'testDeepInArray2'}, 'b', 'c'],
      'test3': 'testValue2'
  ...
  it('Convert array to query string with prefix options', () => {
    const queryString = toQueryString(['a', 'b'], '', {
      arrayPrefix: '[]'
    });
    expect(queryString).to.equal('0[]=a&1[]=b');
